...
experiment_settings["experiment_name"] = "CPC_baseline_100per_NoEmb"
...
# model
# experiment_settings["model"] = "cpc_lstm"  # use it for baseline with embedding layers
experiment_settings["model"] = "CudaLSTM"   # use it for baseline without embedding layers
...
# # Show mean and std values in fine-tining set
...
# checkpoint_path = r"C:\Users\qa8171\Desktop\CPC results\best_model"
