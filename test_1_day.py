...
# experiment_name = "1_day_pred_1"
experiment_name = "test_1_day"
...
model_configuration = {
    ...
    "no_of_epochs": 30, # 30
    "dropout_rate": 0.4,
    "learning_rate": {1: 5e-4, 10: 1e-4, 25: 1e-5},  # {1: 5e-4, 10: 1e-4, 25: 1e-5}
    "set_forget_gate": 3,
    "validate_every": 1, # 5
...
# print("I load model: the best in validation")

model.load_state_dict(torch.load(weights_save_path + "/epoch_30", map_location=device))
print("I load model: epoch_30")
