...
# n_days_in_hourly = 2     # the last n days in hourly resolution, and the remaining days are in daily resolution
...
experiment_name = "2_day_in_hourly_pred_last_24"
...
## Haicore@KIT
path_entities = "/hkfs/home/haicore/iwu/qa8171/Project/Hy2DL/data/basin_id/basins_camels_de_hourly_294_Bayern.txt"
...
if best_model_state is not None:
    torch.save(best_model_state, path_save_folder + "/best_model_at_epoch_" + str(best_epoch))
