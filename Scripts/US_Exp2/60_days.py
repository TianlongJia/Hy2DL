...
# n_days_in_hourly = 60     # the last n days in hourly resolution, and the remaining days are in daily resolution
...
model_configuration = {
    ...
    "custom_freq_processing": {
        ...
        "1D": {
           "n_steps": 123,  # ~2 months (197 - 1 days)
           "freq_factor": 24,  # 24 hours in a day
        },
        "1h": {
           "n_steps": 1440,  # 1 days of hourly data
           "freq_factor": 1
        }
    },
    "predict_last_n": 24,
