...
# n_days_in_hourly = 90     # the last n days in hourly resolution, and the remaining days are in daily resolution
...
model_configuration = {
    ...
    "custom_freq_processing": {
        ...
        "1D": {
           "n_steps": 93,  # ~2 months (197 - 1 days)
           "freq_factor": 24,  # 24 hours in a day
        },
        "1h": {
           "n_steps": 2160,  # 1 days of hourly data
           "freq_factor": 1
        }
    },
    "predict_last_n": 24,
