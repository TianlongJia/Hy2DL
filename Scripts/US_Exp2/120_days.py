...
from hy2dl.datasetzoo.hourlycamelsus import HourlyCamelsUS as Datasetclass
from hy2dl.modelzoo.mflstm import MFLSTM as modelclass

# capture SEED (default: 100)
...
# n_days_in_hourly = 120     # the last n days in hourly resolution, and the remaining days are in daily resolution
...
## Haicore@KIT
path_entities = "/hkfs/home/haicore/iwu/qa8171/Project/Hy2DL/data/basin_id/basins_camels_us_hourly_516.txt"
# path_entities = "/hkfs/home/haicore/iwu/qa8171/Project/Hy2DL/data/basin_id/basins_camels_us_hourly_2.txt"
path_data = "/hkfs/home/haicore/iwu/qa8171/Project/Hy2DL/data/CAMELS_US/"
...
# time periods
training_period = ["1990-10-01 00:00:00", "2003-09-30 23:00:00"]
validation_period = ["2003-10-01 00:00:00", "2008-09-30 23:00:00"]
testing_period = ["2008-10-01 00:00:00", "2018-09-30 23:00:00"]


# # # time periods (for short test)
# training_period = ["1990-10-01 00:00:00", "1992-09-30 23:00:00"]
# validation_period = ["2003-10-01 00:00:00", "2005-09-30 23:00:00"]
# testing_period = ["2008-10-01 00:00:00", "2010-09-30 23:00:00"]

# model configuration
model_configuration = {
    "n_dynamic_channels_lstm": 11,
    "no_of_layers": 1,
    ...
    "custom_freq_processing": {
        ...
        "1D": {
           "n_steps": 63,  # ~2 months (197 - 1 days)
           "freq_factor": 24,  # 24 hours in a day
        },
        "1h": {
           "n_steps": 2880,  # 1 days of hourly data
           "freq_factor": 1
        }
    },
    "predict_last_n": 24,
    ...
    "set_forget_gate": 3,
    "validate_every": 1,   # Edu sets it to 4
...
print("***************  Loading the best_epoch model  ****************")
...
report = (
    "***************** Test the *best_epoch* model on test dataset: *******************\n"
...
# print evaluation report
report = (
    "***************** Test the *final_epoch* model on test dataset: *******************\n"
    f"Median NSE across all basins: {median_nse:.3f}\n"
    f"Mean NSE across all basins: {mean_nse:.3f}\n"
    f"Total evaluation time: {'%.1f ' % evaluation_time} min"
)
