...
experiment_name = "mflstm_hourly_de_workshop"

# paths to access the information
path_entities = "/home/ka/ka_iwu/ka_qt7760/Github/Hy2DL/data/basin_id/basins_camels_de_hourly_1021.txt"
path_data = "/home/ka/ka_iwu/ka_qt7760/datasets/CAMELS_DE"
...
model_configuration = {
    ...
    "predict_last_n": 1,             # "predict" 24 timesteps at once (in simulation mode without Q as input, this should be fine, as only meteorological data is used)
    ...
    "no_of_epochs": 10, # 30
    "dropout_rate": 0.4,
    "learning_rate": {1: 5e-4, 3: 1e-4, 5: 1e-5},  # {1: 5e-4, 10: 1e-4, 25: 1e-5}
    "set_forget_gate": 3,
    "validate_every": 3,
...
## predict_last_n=1, new basedataset, 4 epochs, unique_prediction_blocks=False (2348s)
print(f"\nMedian NSE: {df_NSE['NSE'].median()}")
